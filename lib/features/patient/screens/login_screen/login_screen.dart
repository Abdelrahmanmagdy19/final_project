...
import 'package:cure_link/features/patient/screens/sigin_screen/sig_in_screen.dart';
      ...
      body: BlocListener<LoginSiginCubits, LoginSiginCubitsState>(
        listener: (context, state) {
          ...
          if (state is LoginSiginCubitsSuccess) {
            ...
            final bool isDoctor = state.role.toLowerCase() == 'doctor';
            Navigator.of(context).pushAndRemoveUntil(
              MaterialPageRoute(
                builder: (_) => isDoctor
                    ? const DoctorDashboardShell()
